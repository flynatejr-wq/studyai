 ...
 *                      e.g. "StudyBuddi <noreply@studybuddi.app>"
...
export async function sendWelcomeEmail(toEmail, name) {
  await resend.emails.send({
    ...
    html:    wrap(`
      ...
      <a href="${process.env.FRONTEND_URL || "https://studybuddi.app"}/dashboard" class="btn">Open StudyBuddi →</a>
...
export async function sendUpgradePromptEmail(toEmail, name) {
  await resend.emails.send({
    ...
    html:    wrap(`
      ...
      <a href="${process.env.FRONTEND_URL || "https://studybuddi.app"}/settings" class="btn">Upgrade to Pro →</a>
