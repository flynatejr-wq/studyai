 ...
 *                      e.g. "StudyBuddi <noreply@client-opal-five-85.vercel.app>"
...
export async function sendWelcomeEmail(toEmail, name) {
  await resend.emails.send({
    ...
    html:    wrap(`
      ...
      <a href="${process.env.FRONTEND_URL || "https://client-opal-five-85.vercel.app"}/dashboard" class="btn">Open StudyBuddi →</a>
...
export async function sendUpgradePromptEmail(toEmail, name) {
  await resend.emails.send({
    ...
    html:    wrap(`
      ...
      <a href="${process.env.FRONTEND_URL || "https://client-opal-five-85.vercel.app"}/settings" class="btn">Upgrade to Pro →</a>
