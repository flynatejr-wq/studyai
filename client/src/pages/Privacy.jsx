    ...
    <div className="min-h-screen bg-[#0a0a12] text-gray-300">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        {[
          ...
          ["6. Cookies & Local Storage", "We use browser localStorage to store your authentication token. We use Mixpanel (product analytics) and LogRocket (session recording) to understand how the service is used and to diagnose errors. These tools receive anonymised usage events and, when you are logged in, your user ID. They do not receive your password or full study guide content. You can opt out of analytics by using a browser with a tracking blocker."],
