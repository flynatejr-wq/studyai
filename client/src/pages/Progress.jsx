...
export default function Progress() {
  ...
  if (loading) return (
    <div className="flex min-h-dvh bg-[#0a0a12] w-full overflow-x-hidden">
      ...
      <main className="flex-1 min-w-0 overflow-x-hidden md:ml-64 flex items-center justify-center main-pt-snug">
  ...
  return (
    <div className="flex min-h-dvh bg-[#0a0a12] w-full overflow-x-hidden">
      <Sidebar onLogout={logout} />
      <main className="flex-1 min-w-0 overflow-x-hidden md:ml-64 p-4 md:p-8 main-pt max-w-5xl w-full">
